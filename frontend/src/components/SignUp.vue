      ...
      <form @submit.prevent="handleSignUp">
        ...
        <div class="input-group">
          ...
          <div class="input-container group">
            ...
            <svg class="input-icon clickable" viewBox="0 0 24 24" @click="hidePassword">
        ...
        <div class="input-group">
          ...
          <div class="input-container group">
            ...
            <input :type="showPassword2 ? 'text' : 'password'" id="confirm-password" v-model="confirmPassword" required class="input" />
            <svg class="input-icon clickable" viewBox="0 0 24 24" @click="hideConfirmPassword">
