<template>
  <div class="sidebar" :class="{ 'sidebarExpanded': menuOpen }">
    ...
    <nav class="navMenu">
      ...
      <!-- Button to navigate to the user settings page -->
      ...
      <router-link to="/history" class="navItem">
        <svg xmlns="http://www.w3.org/2000/svg" class="navIcon" width="24" height="24" viewBox="0 0 24 24">
          <path fill="currentColor"
      ...
      <!-- Button to navigate to the graphs page -->
      <router-link to="/graphs" class="navItem">
      ...
      <!-- Button to navigate to the project repository -->
